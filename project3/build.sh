...
arm-none-eabi-gcc -o project3.elf $ARCH_FLAGS $CFLAGS $INCLUDES $LDFLAGS $SRC
arm-none-eabi-objcopy -O binary project3.elf project3.bin
arm-none-eabi-objdump -x -S -C project3.elf > project3.lst
arm-none-eabi-size project3.elf
